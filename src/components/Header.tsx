          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                href={link.path}
                className={cn(
                  "border-b-2 border-transparent pb-1 text-[15px] font-medium tracking-wide text-[#2C2C2C] transition-colors duration-200 hover:text-[#F5C518]",
        ...
        >
          ...
          <div className="bg-[#FAF8F4] px-6 py-5">
            ...
            <Link
              ...
              onClick={() => setMobileOpen(false)}
              className="block w-full rounded-md bg-[#F5C518] px-4 py-2 text-center text-sm font-semibold text-[#2C2C2C]"
            >
              Apply as Driver →
            </Link>
          </div>
